...
app = Flask('')
NAME='𝑽𝟑𝑳𝑶𝑹𝑬~/ 𝙃𝙊𝙎𝙏𝙄𝙉𝙂 💎'  #Add what ever you want to desplay in bot like , i am ____ hostin bot 
@app.route('/')
def home():
...
# --- Configuration ---
TOKEN = '8974103237:AAFPBiEDI9wbqbf6E2GzZJobiWR7xHeZFsQ'
OWNER_ID = 8801597169 # ADD YOUR USER ID 
ADMIN_ID = 8801597169 # DON'T REPLACE IF REPLACE THEN BOT NOT WORKING 
YOUR_USERNAME = '@V3LORE_x7x' # ADD YOUR USERNAME 
UPDATE_CHANNEL = '@V3LOREBOT' # ADD YOUR YOU CHANNEL USERNAME 
